...
* **Binary install**: Get a release [here](https://github.com/everactive/go-jsonschema/releases).
...
$ go install github.com/everactive/go-jsonschema/cmd/gojsonschema@latest
```
